...
std::string openBaseString = "astral_gazebo";
...
astral_gazebo::KinematicsForward service;

ros::Time timeCurrent;
ros::Time timePrevious;

void onEncoderMessage(const astral_gazebo::Velocity::ConstPtr& input){
    service.request.input.v_front_left  = input->v_front_left  * r;
    service.request.input.v_back_right  = input->v_back_right  * r;
    service.request.input.v_front_right = input->v_front_right * r;
...
int main(int argc, char **argv){
    ...
    kinematicsForwardWorld  = node.serviceClient<astral_gazebo::KinematicsForward>("kinematics_forward_world" );
    kinematicsForwardMobile = node.serviceClient<astral_gazebo::KinematicsForward>("kinematics_forward_mobile");
